...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-charcoal-900 text-white overflow-hidden">
      <NeuralNetwork />
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-6">
        ...
        >
          ...
          <h2 className="text-2xl md:text-4xl mb-8 text-lavender-400">
            & AI Engineer
          </h2>
        </motion.div>
